/* StrKeysym.c -- replacement for libX11's XStringToKeysym / _XInitKeysymDB.
   Built separately and linked into xkbcomp.exe to avoid pulling in the
   entire libX11 version which has dependencies on locale modules. */
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
#include <stdio.h>
